...
JuJuBenchTable = { "White", "Pink", "Black", "Green", "Red" }

for v in pairs(JuJuBenchTable) do
	minetest.register_node("jujubench:"..JuJuBenchTable[v].."_JuJu_bench_3x3", {
		description = JuJuBenchTable[v].." JuJu Bench",
		tile_images = {JuJuBenchTable[v].."_JuJu_Bench_3x3_top.png","JuJu_Bench_3x3_bottom.png","JuJu_Bench_3x3_side.png"},
		paramtype2 = "facedir",
		groups = {cracky=2},
		...
		on_construct = function(pos)
			...
			meta:set_string("infotext", JuJuBenchTable[v].." JuJu Casting Bench")
...
minetest.register_node("jujubench:4x4", {
...
minetest.register_node("jujubench:5x5", {
	description = "5x5 WorkBench",
	tile_images = {"workbench_5x5_top.png","workbench_5x5_bottom.png","workbench_5x5_side.png"},
	paramtype2 = "facedir",
	groups = {cracky=2},
	legacy_facedir_simple = true,
	sounds = default.node_sound_stone_defaults(),
